...
{
    /// <inheritdoc />
    public partial class SuanoidungDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoaiDongHo", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoaiDongHoID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SanPham_LoaiDongHo_LoaiDongHoID",
                        column: x => x.LoaiDongHoID,
                        principalTable: "LoaiDongHo",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NhanVien_PhanQuyen_PhanQuyenID",
